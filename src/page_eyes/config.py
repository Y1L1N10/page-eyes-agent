...
class CosConfig(BaseSettings):
    model_config = SettingsConfigDict(
        env_file=".env", env_prefix="cos_", extra="ignore"
    )
...
class OmniParserConfig(BaseSettings):
    model_config = SettingsConfigDict(
        env_file=".env", env_prefix="omni_", extra="ignore"
    )
...
class Settings(BaseSettings):
    ...
    storage_client: StorageClient = StorageClient.create_from_config(
        CosConfig(), MinioConfig()
    )
